...
mod path_sanitization_tests {
    ...
    fn test_sanitize_path_directory_traversal() {
        ...
        assert_eq!(sanitize_path("/../../etc/passwd"), "/etc/passwd");
        assert_eq!(sanitize_path("/css/../../../etc/passwd"), "/etc/passwd");
        assert_eq!(sanitize_path("/../../../"), "/");
    }
    
    #[test]
    fn test_sanitize_path_query_parameters() {
        assert_eq!(sanitize_path("/index.html?param=value"), "/index.html");
        assert_eq!(sanitize_path("/api/data?id=123&name=test"), "/api/data");
    }
    
    #[test]
    fn test_sanitize_path_fragments() {
        assert_eq!(sanitize_path("/page.html#section"), "/page.html");
        assert_eq!(sanitize_path("/index.html?param=value#top"), "/index.html");
    }
    
    #[test]
    fn test_sanitize_path_without_leading_slash() {
        assert_eq!(sanitize_path("index.html"), "/index.html");
        assert_eq!(sanitize_path("css/style.css"), "/css/style.css");
    }
    
    #[test]
    fn test_sanitize_path_current_directory() {
        assert_eq!(sanitize_path("/./index.html"), "/index.html");
        assert_eq!(sanitize_path("/css/./style.css"), "/css/style.css");
    }
    
    #[test]
    fn test_sanitize_path_mixed_attacks() {
        assert_eq!(sanitize_path("/css/../js/../index.html"), "/index.html");
        assert_eq!(sanitize_path("/../css/./../../js/app.js"), "/js/app.js");
    }
}
